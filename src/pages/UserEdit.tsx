        ...
        <div>
            ...
            <div className='details'>
                ...
                <div className='sixth-line'>
                    <TextField id="outlined-basic" className='bio-text-field' label="Add Bio.." variant="outlined" />
                </div>
                <div className='update-btn-block'>
                    <Button variant="contained" className='update-btn button' size="small" onClick={() => {
